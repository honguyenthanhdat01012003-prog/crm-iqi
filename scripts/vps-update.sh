...
cd "$ROOT"
PORT="${PORT:-4000}"
EXPECTED_VERSION_PREFIX="2026-07-16-autosync-rotate"
...
echo "Expect version: 2026-07-16-autosync-rotate-m"
echo "aaPanel Memory Limit: để trống hoặc ≥ 1536M (keeper mặc định heap 1536)"
